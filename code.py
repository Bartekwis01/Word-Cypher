...
if os.path.exists(WORDS_PATH):
    ...
    print(f'No words file detected. Please move a file named {WORDS_PATH} into the same folder as the app and run the '
...
if os.path.exists(DICTIONARY_PATH):
    ...
    print(f'WARNING - no dictionary file detected. The program will create a new one. This is normal when running the '
